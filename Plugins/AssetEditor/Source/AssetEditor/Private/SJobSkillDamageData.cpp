...
TArray<TSharedPtr<SAssetCheckBoxes>> SJobSkillDamageData::CheckBoxes;

TSharedRef<IPropertyTypeCustomization> SJobSkillDamageData::MakeInstance()
{
	return MakeShareable(new SJobSkillDamageData());
}

TSharedPtr<SAssetCheckBoxes> SJobSkillDamageData::AddCheckBoxes()
{
...
void SJobSkillDamageData::EmptyCheckBoxes()
{
...
void SJobSkillDamageData::CustomizeHeader(TSharedRef<IPropertyHandle> InPropertyHandle, FDetailWidgetRow& InHeaderRow, IPropertyTypeCustomizationUtils& InCustomizationUtils)
{
...
void SJobSkillDamageData::CustomizeChildren(TSharedRef<IPropertyHandle> InPropertyHandle, IDetailChildrenBuilder& InChildBuilder, IPropertyTypeCustomizationUtils& InCustomizationUtils)
{
	if (SAssetCheckBoxes::CanDraw(InPropertyHandle, CheckBoxes.Num()) == false)
	{
		uint32 number = 0;
